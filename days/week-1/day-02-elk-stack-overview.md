...
**Week:** 1 | **Phase:** SIEM Theory
**← [Back to README](../../README.md) | [← Day 01](./day-01-introduction-and-network-diagram.md)**
...
| ELK Component | Splunk Equivalent |
|---------------|-------------------|
...
*→ Next: [Day 03 — Setting Up Elasticsearch](./day-03-setting-up-elasticsearch.md)*
