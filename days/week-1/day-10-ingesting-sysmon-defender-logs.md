...
**Week:** 1 | **Phase:** Log Ingestion
**← [Back to README](../../README.md) | [← Day 09](./day-09-installing-sysmon.md)**

---

## 1. Introduction

**Goal:** Ingest Sysmon and Microsoft Defender event logs from the Windows Server into Elasticsearch.
...
3. Name the integration: `Challenge-Win-Sysmon`.
...
8. Click **Save and Continue** → **Save and Deploy Changes**.
...
2. Name the integration: `Challenge-Win-Defender`.
3. Description: `Collect Windows Defender logs from windows for Event ID 1116, 1117 & 5001`.
...
6. Specify event IDs to include: `1116, 1117, 50001`.
7. Add the integration to an existing host and select the agent policy.
8. Click **Save and Continue** → **Save and Deploy Changes**.
...
*→ Next: [Day 11 — Brute Force Theory](../week-2/day-11-brute-force-theory.md)*
